...
const (
	...
	shortcutGuideHeight         = 870
	shortcutGuideTableHeight    = 704
...
func (g *shortcutGuideWindow) build() {
	...
	root.AddSubview(button(620, 812, 112, nativeControls.PrimaryButtonHeight, "Close", "shortcuts.close", g.window.Close))
	g.window.Show()
}
