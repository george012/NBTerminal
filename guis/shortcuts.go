...
const (
	...
	shortcutGuideHeight         = 845
	shortcutGuideTableHeight    = 679
...
func (g *shortcutGuideWindow) build() {
	...
	root.AddSubview(button(620, 787, 112, nativeControls.PrimaryButtonHeight, "Close", "shortcuts.close", g.window.Close))
	g.window.Show()
}
